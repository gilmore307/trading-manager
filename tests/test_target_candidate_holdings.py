...
class TargetCandidateHoldingsTests(unittest.TestCase):
    def test_builds_layer_two_target_candidate_holdings_task_key(self) -> None:
        with tempfile.TemporaryDirectory() as raw_tmp:
            ...
            self.assertEqual(task_key["manager_controls"]["allowed_providers"], ["etf_issuer_holdings"])
            self.assertEqual(task_key["manager_controls"]["allowed_endpoint_families"], ["holdings_file"])
