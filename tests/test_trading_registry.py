...
class RegistryHelperTests(unittest.TestCase):
    ...
    def test_data_feed_and_data_source_rows_are_separated(self):
        ...
        self.assertIn("mpdec_d743cb5dbc8159f2", rows["MODEL_PROMOTION_CLOSEOUT_DECISION_RECEIPTS"]["payload"])
        self.assertIn("mpdec_70fef0f31847cc1c", rows["MODEL_PROMOTION_CLOSEOUT_DECISION_RECEIPTS"]["payload"])
        self.assertIn("mpdec_e7448aaab1334345", rows["MODEL_PROMOTION_CLOSEOUT_DECISION_RECEIPTS"]["payload"])
        self.assertEqual(rows["REVIEW_LAYERS_03_08_PROMOTION_CLOSEOUT"]["kind"], "script")
    ...
    def test_manager_control_plane_contracts_are_registered_concisely(self):
        ...
        self.assertIn("09:20-16:10_et_only_on_regular_us_equity_trading_days", rows["MANAGER_MARKET_HOURS_HISTORICAL_PAUSE_POLICY"]["payload"])
        ...
        self.assertIn("dispatch_approved_provider_acquisition.py", rows["MANAGER_APPROVED_PROVIDER_ACQUISITION_DISPATCH"]["path"])
        ...
        self.assertIn("provider_calls_require_live_call_approval_v1", rows["MANAGER_DATASET_EXPANSION_POLICY"]["payload"])
