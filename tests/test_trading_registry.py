...
class RegistryHelperTests(unittest.TestCase):
    ...
    def test_data_feed_and_data_source_rows_are_separated(self):
        ...
        self.assertIn("layer_8_deferred_no_production_eval_substrate", rows["MODEL_PROMOTION_READINESS_STATUS_MATRIX"]["payload"])
        self.assertIn("mpdec_d743cb5dbc8159f2", rows["MODEL_PROMOTION_CLOSEOUT_DECISION_RECEIPTS"]["payload"])
        self.assertIn("mpdec_90721592be6591c8", rows["MODEL_PROMOTION_CLOSEOUT_DECISION_RECEIPTS"]["payload"])
        self.assertIn("layers_3_8_missing_production_eval_run_labels_metrics", rows["MODEL_PROMOTION_CLOSEOUT_BLOCKERS"]["payload"])
