...
class DashboardReadModelProducerTests(unittest.TestCase):
    ...
    def test_builds_historical_task_progress_summary_payload(self):
        ...
        self.assertEqual(task_timeline[0]["worker_id"], "input_materialization_worker")
        self.assertEqual(task_timeline[0]["detail"]["worker"]["worker_label"], "Input Materialization Worker")
        self.assertEqual(task_timeline[2]["stage_type"], "feature_generation")
        self.assertEqual(task_timeline[2]["worker_label"], "Feature Generation Worker")
