...
class EventFeedBackfillTests(unittest.TestCase):
    def test_plans_required_event_feeds_for_each_month(self):
        ...
        self.assertNotIn("12_feed_official_calendar_discovery", {row["target_component_id"] for row in requests})
    ...
    def test_writes_enriched_event_feed_task_keys_without_provider_calls(self):
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(summary.task_key_count, 3)
            ...
            self.assertNotIn("12_feed_official_calendar_discovery", by_feed)
