...
class LayerNineOptionExpressionGateTests(unittest.TestCase):
    def test_no_trade_layer_seven_rows_accept_no_provider_skip(self) -> None:
        ...
        self.assertEqual(review.total_layer_7_rows, 2)
    ...
    def test_active_layer_seven_rows_preview_thetadata_requests(self) -> None:
        ...
        previews = request_previews_from_layer_7_rows(rows, start_month="2016-01")
        review = build_layer_nine_gate_review(start_month="2016-01", end_month="2016-01", layer_7_rows=rows)
    ...
    def test_written_no_provider_skip_receipt_is_safe_and_stage_scoped(self) -> None:
        review = build_layer_nine_gate_review(start_month="2016-01", end_month="2016-01", layer_7_rows=[])
