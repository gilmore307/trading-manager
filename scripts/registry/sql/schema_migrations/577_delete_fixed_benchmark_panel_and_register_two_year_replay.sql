...
VALUES
  (
    'term_EVALBMK2YR001',
    'term',
    'PROMOTION_BENCHMARK_TWO_YEAR_REPLAY_WINDOW',
    'text',
    ...
    'sync_artifact',
    'Promotion benchmark contracts must give the candidate model at least two calendar years and 504 expected trading days under a historical clock, with final target selection performed by the model route rather than by a preselected ticker panel.'
  )
