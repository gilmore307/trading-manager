...
ALTER TABLE IF EXISTS trading_model.model_09_event_risk_governor RENAME TO model_08_event_risk_governor;
...
ALTER TABLE IF EXISTS trading_model.model_07_option_expression RENAME TO model_09_option_expression;
...
ALTER INDEX IF EXISTS trading_model.model_09_event_risk_governor_pkey RENAME TO model_08_event_risk_governor_pkey;
...
ALTER INDEX IF EXISTS trading_model.model_07_option_expression_pkey RENAME TO model_09_option_expression_pkey;
...
BEGIN
  FOR item IN
    SELECT * FROM (VALUES
      ('trading_model','model_08_event_risk_governor','4_event_','8_event_'),
      ('trading_model','model_08_event_risk_governor','9_event_','8_event_'),
      ...
      ('trading_model','model_09_option_expression','7_','9_'),
      ('trading_data','feature_09_event_risk_governor','4_event_','8_event_'),
      ('trading_data','feature_09_event_risk_governor','8_event_','8_event_'),
...
SET model_id = CASE WHEN model_id IN ('event_overlay_model', 'model_09_event_risk_governor') THEN 'event_risk_governor' ELSE model_id END,
    model_layer = replace(replace(model_layer, 'layer_04_event_overlay', 'layer_08_event_risk_governor'), 'layer_09_event_risk_governor', 'layer_08_event_risk_governor'),
    event_context_vector_ref = replace(replace(replace(replace(event_context_vector_ref, 'model_04_event_overlay', 'model_08_event_risk_governor'), 'model_09_event_risk_governor', 'model_08_event_risk_governor'), 'event_overlay', 'event_risk_governor'), 'layer_09_event_risk_governor', 'layer_08_event_risk_governor'),
    event_context_vector = replace(replace(replace(replace(replace(event_context_vector::text, '"4_event_', '"8_event_'), '"9_event_', '"8_event_'), 'layer_04_event_overlay', 'layer_08_event_risk_governor'), 'model_09_event_risk_governor', 'model_08_event_risk_governor'), 'event_overlay', 'event_risk_governor')::jsonb,
    event_risk_governor_diagnostics = replace(replace(replace(replace(replace(event_risk_governor_diagnostics::text, '"4_event_', '"8_event_'), '"9_event_', '"8_event_'), 'layer_04_event_overlay', 'layer_08_event_risk_governor'), 'model_09_event_risk_governor', 'model_08_event_risk_governor'), 'event_overlay', 'event_risk_governor')::jsonb
WHERE model_layer LIKE '%layer_04_event_overlay%'
   OR model_layer LIKE '%layer_09_event_risk_governor%'
   OR model_id = 'event_overlay_model'
   OR event_context_vector_ref LIKE '%event_overlay%'
   OR event_context_vector_ref LIKE '%model_09_event_risk_governor%'
   OR event_context_vector::text LIKE '%4\_event\_%' ESCAPE '\'
   OR event_context_vector::text LIKE '%9\_event\_%' ESCAPE '\'
   OR event_risk_governor_diagnostics::text LIKE '%event_overlay%'
   OR event_risk_governor_diagnostics::text LIKE '%9\_event\_%' ESCAPE '\';
...
SET model_layer = replace(model_layer, 'layer_04_alpha_confidence', 'layer_05_alpha_confidence'),
    ...
    event_context_vector_ref = replace(replace(replace(event_context_vector_ref, 'model_04_event_overlay', 'model_08_event_risk_governor'), 'model_08_event_risk_governor', 'model_08_event_risk_governor'), 'event_overlay', 'event_risk_governor'),
    ...
    alpha_confidence_diagnostics = replace(replace(replace(replace(alpha_confidence_diagnostics::text, '"4_', '"5_'), 'layer_04_alpha_confidence', 'layer_05_alpha_confidence'), 'model_04_alpha_confidence', 'model_05_alpha_confidence'), 'model_04_event_overlay', 'model_08_event_risk_governor')::jsonb
...
UPDATE trading_model.model_09_option_expression
SET model_layer = replace(model_layer, 'layer_07_option_expression', 'layer_09_option_expression'),
    underlying_action_plan_ref = replace(replace(underlying_action_plan_ref, 'model_06_underlying_action', 'model_07_underlying_action'), 'layer_06_underlying_action', 'layer_07_underlying_action'),
    option_expression_plan_ref = replace(replace(option_expression_plan_ref, 'model_07_option_expression', 'model_09_option_expression'), 'layer_07_option_expression', 'layer_09_option_expression'),
    option_expression_plan = replace(replace(replace(option_expression_plan::text, '"7_', '"9_'), 'layer_07_option_expression', 'layer_09_option_expression'), 'model_07_option_expression', 'model_09_option_expression')::jsonb,
    expression_vector = replace(replace(replace(expression_vector::text, '"7_', '"9_'), 'layer_07_option_expression', 'layer_09_option_expression'), 'model_07_option_expression', 'model_09_option_expression')::jsonb
...
SET source_name = replace(replace(replace(source_name, 'source_04_event_overlay', 'source_09_event_risk_governor'), 'source_08_event_risk_governor', 'source_09_event_risk_governor'), 'event_overlay', 'event_risk_governor'),
    reference = replace(replace(replace(replace(replace(reference, 'source_04_event_overlay', 'source_09_event_risk_governor'), 'source_08_event_risk_governor', 'source_09_event_risk_governor'), 'layer_04_event_overlay', 'layer_08_event_risk_governor'), 'layer_09_event_risk_governor', 'layer_08_event_risk_governor'), 'event_overlay', 'event_risk_governor')
WHERE source_name LIKE '%source_04_event_overlay%'
   ...
   OR reference LIKE '%layer_09_event_risk_governor%'
   OR reference LIKE '%event_overlay%';

UPDATE trading_data.feature_09_event_risk_governor
SET run_id = replace(replace(replace(run_id, 'feature_04_event_overlay', 'feature_09_event_risk_governor'), 'feature_08_event_risk_governor', 'feature_09_event_risk_governor'), 'layer_04_event_overlay', 'layer_08_event_risk_governor'),
    source_run_ref = replace(replace(replace(source_run_ref, 'source_04_event_overlay', 'source_09_event_risk_governor'), 'source_08_event_risk_governor', 'source_09_event_risk_governor'), 'layer_04_event_overlay', 'layer_08_event_risk_governor'),
    feature_payload_json = replace(replace(replace(replace(replace(replace(feature_payload_json::text, '"4_event_', '"8_event_'), '"9_event_', '"8_event_'), 'feature_04_event_overlay', 'feature_09_event_risk_governor'), 'feature_08_event_risk_governor', 'feature_09_event_risk_governor'), 'source_04_event_overlay', 'source_09_event_risk_governor'), 'event_overlay', 'event_risk_governor')::jsonb,
    feature_quality_diagnostics = replace(replace(replace(replace(replace(replace(replace(feature_quality_diagnostics::text, '"4_event_', '"8_event_'), '"9_event_', '"8_event_'), 'feature_04_event_overlay', 'feature_09_event_risk_governor'), 'feature_08_event_risk_governor', 'feature_09_event_risk_governor'), 'source_04_event_overlay', 'source_09_event_risk_governor'), 'source_08_event_risk_governor', 'source_09_event_risk_governor'), 'event_overlay', 'event_risk_governor')::jsonb
WHERE run_id LIKE '%feature_04_event_overlay%'
   ...
   OR feature_payload_json::text LIKE '%9\_event\_%' ESCAPE '\'
   OR feature_payload_json::text LIKE '%event_overlay%'
   OR feature_quality_diagnostics::text LIKE '%4\_event\_%' ESCAPE '\'
   OR feature_quality_diagnostics::text LIKE '%9\_event\_%' ESCAPE '\'
