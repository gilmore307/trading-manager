...
| Provider/reconcile | `dispatch_provider_acquisition.py`, `dispatch_and_reconcile_provider_stage.py`, `reconcile_provider_stage.py`, `dispatch_event_feed_backfill.py`, `prepare_layer_nine_event_feed_backfill.py` |
...
| Layer-specific helpers | `materialize_layer_three_target_state_inputs.py`, `review_target_layer2_context_mapping.py`, `review_layer_eight_option_expression_gate.py`, `execute_layer_eight_option_feature_generation.py`, `materialize_layer_nine_event_risk_governor_inputs.py`, `plan_event_model_regeneration.py`, `invalidate_layer_nine_event_downstream_outputs.py` |
