...
| Provider/reconcile | `dispatch_provider_acquisition.py`, `dispatch_and_reconcile_provider_stage.py`, `reconcile_provider_stage.py`, `dispatch_event_feed_backfill.py`, `prepare_layer_ten_event_feed_backfill.py` |
...
| Layer-specific helpers | `execute_layer_two_feature_generation.py`, `prepare_option_chain_source_acquisition.py`, `dispatch_option_chain_source_acquisition.py`, `materialize_layer_three_target_state_inputs.py`, `review_target_layer2_context_mapping.py`, `execute_layer_nine_option_feature_generation.py`, `materialize_layer_ten_event_risk_governor_inputs.py`, `plan_event_model_regeneration.py`, `invalidate_layer_ten_event_downstream_outputs.py` |
