...
-- Bootstrap fields for the registry table itself, the first ratified shared workflow slots, and the default shared status vocabularies.
INSERT INTO trading_registry (id, kind, key, payload_format, payload, note)
VALUES
  ('fld_A7K3P2Q9', 'field', 'REGISTRY_ITEM_ID', 'text', 'id', 'canonical column name for trading_registry.id'),
  ('fld_M4N8X2KD', 'field', 'REGISTRY_ITEM_KIND', 'text', 'kind', 'canonical column name for trading_registry.kind'),
  ('fld_R7P1C6LW', 'field', 'REGISTRY_ITEM_KEY', 'text', 'key', 'canonical column name for trading_registry.key'),
  ('fld_T9V2H5QS', 'field', 'REGISTRY_ITEM_PAYLOAD_FORMAT', 'text', 'payload_format', 'canonical column name for trading_registry.payload_format'),
  ('fld_B6J4N8XP', 'field', 'REGISTRY_ITEM_PAYLOAD', 'text', 'payload', 'canonical column name for trading_registry.payload'),
  ('fld_D3W7K1RM', 'field', 'REGISTRY_ITEM_NOTE', 'text', 'note', 'canonical column name for trading_registry.note'),
  ('fld_P8L2C4TY', 'field', 'REGISTRY_ITEM_CREATED_AT', 'text', 'created_at', 'canonical column name for trading_registry.created_at'),
  ('fld_Q5F9M2NZ', 'field', 'REGISTRY_ITEM_UPDATED_AT', 'text', 'updated_at', 'canonical column name for trading_registry.updated_at'),
  ...
  ('scr_YO00DVVP', 'script', 'REGISTRY_READER_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/registry/registry-reader.js', 'canonical full script address for the registry reader helper source file'),
  ('scr_MA60CYT4', 'script', 'REGISTRY_TYPES_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/registry/registry-types.js', 'canonical full script address for the registry types helper source file'),
  ('scr_7XQAMNBH', 'script', 'REGISTRY_INDEX_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/registry/index.js', 'canonical full script address for the registry entrypoint source file'),
  ('scr_Q2L6F8MW', 'script', 'SECRET_RESOLVER_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/registry/secret-resolver.js', 'canonical full script address for the secret resolver helper source file'),
  ...
  ('trm_4F58616K', 'term', 'POSTGRESQL', 'text', 'Open-source relational database system used as the target engine for trading-main registry and related server-side data work.', 'canonical shared definition for PostgreSQL'),
  ...
  ('trm_QLKAMITP', 'term', 'TRADING_MAIN_REGISTRY', 'text', 'Trading-main registry for trading-wide referenced values, approved outputs, source locators, status vocabularies, and approved terms.', 'canonical shared definition for trading-main registry'),
  ...
  ('rep_H6S3V8LA', 'repo', 'TRADING_MAIN_REPO', 'text', 'trading-main', 'canonical repository name for the trading-main project'),
  ...
  ('pth_C4X8N2ME', 'path', 'TRADING_MAIN_ROOT_PATH', 'text', '/root/projects/trading-main', 'repository root path for the trading-main checkout'),
  ...
  ('cfg_P4R8T2LM', 'config', 'NETWORK_FRAMEWORK_COMPANION_TOKEN_SECRET_ALIAS', 'text', 'network-framework/companion-token', 'approved config key for the phase-1 network-framework companion bearer token secret alias; the registry stores the alias reference, not the secret value or file contents'),
  ...
  ('cfg_U8C2D6YA', 'config', 'OPENCLAW_DATABASE_URL_SECRET_ALIAS', 'text', 'openclaw/database-url', 'approved config key for the active OpenClaw PostgreSQL database URL secret alias; the registry stores the alias reference, not connection secret material')
