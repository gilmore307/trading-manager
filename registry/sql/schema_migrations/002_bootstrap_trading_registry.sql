...
VALUES
  ...
  ('scr_YO00DVVP', 'script', 'REGISTRY_READER_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/catalog/catalog-reader.js', 'canonical full script address for the registry reader helper source file'),
  ('scr_MA60CYT4', 'script', 'REGISTRY_TYPES_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/catalog/catalog-types.js', 'canonical full script address for the registry types helper source file'),
  ('scr_7XQAMNBH', 'script', 'REGISTRY_INDEX_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/catalog/index.js', 'canonical full script address for the registry entrypoint source file'),
  ('scr_Q2L6F8MW', 'script', 'SECRET_RESOLVER_SCRIPT_ADDRESS', 'text', '/root/projects/trading-main/helpers/catalog/secret-resolver.js', 'canonical full script address for the secret resolver helper source file'),
