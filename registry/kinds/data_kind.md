...
A data kind names the saved/output shape, not every provider endpoint, transient source input, entitlement-blocked interface, source-interface catalog item, or retired preview/template file.
