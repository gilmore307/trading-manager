...
Canonical shared field names whose values are human-readable free-text, narrative notes, explanations, summaries, caveats, or documentation-oriented text columns.

Use this kind for fields such as `summary`, `coverage_reason`, `known_caveats`, `request_parameters`, `acceptance_summary`, `change_summary`, `maintenance_summary`, `task_status_summary`, and registry `note`.
...
- Use `error_field` for structured or textual error payload fields.
