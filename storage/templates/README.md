...
`storage/templates/` stores reusable trading-wide templates for docs, contracts, task prompts, manifests, requests, ready signals, and helper usage.
...
- `data_tasks/` — parked draft templates for manager-driven historical `trading-source` acquisition tasks. These are not active registry contracts until the task architecture is redesigned after model/bundle contracts settle.
