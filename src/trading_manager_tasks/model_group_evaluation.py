...
def _build_settlement_run(
    *,
    ...
    return {
        ...
        "fold_stack_status": "complete_m01_m05",
        "model_activation_performed": False,
    ...
    *,
    ...
    return {
        ...
        "unknown_requires_evidence": {
            ...
            "regime_event_miss": ["m03_event_state_trace", "regime_state", "co_event_controls"],
        },
        "gate_failures": gate_failures,
...
def _build_promotion_eligibility_decision(
    *,
    ...
    return {
        ...
        "fold_stack_status": str(settlement.get("fold_stack_status") or "complete_m01_m05"),
