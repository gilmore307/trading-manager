...
MONTHLY_EVENT_FEED_IDS = REQUIRED_EVENT_FEED_IDS
...
def _parameter_ref(feed_id: str, month: str, target_symbol: str) -> str:
    source_id = SOURCE_BY_FEED_ID[feed_id]
    return f"storage://trading-manager/monthly_backfill/{source_id}/{month}/task_keys/{target_symbol.lower()}/task_key.json"
