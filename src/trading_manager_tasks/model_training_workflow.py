...
LAYER_METADATA: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "candidate_progression_policy": "collect fold-scoped event-observation readiness, then generate model-facing event failure gates only from Layer 10 / review-owned event_interpretation evidence",
        "data_surface": "fold-scoped event-observation readiness plus reviewed event_interpretation normalization into event_strategy_failure_gate evidence; no raw event alpha requirement",
        "input_stage": True,
