    ...
    return EventModelRegenerationPlan(
        ...
        regeneration_steps=(
            ...
            RegenerationStep(
                ...
                command_ref="python3 scripts/models/model_09_event_risk_governor/evaluate_model_09_event_risk_governor.py; PYTHONPATH=src python3 scripts/tasks/plan_model_promotion_review.py --model event_risk_governor",
