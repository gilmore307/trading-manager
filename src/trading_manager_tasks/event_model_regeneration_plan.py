...
def build_event_model_regeneration_plan(
    *,
    ...
    return EventModelRegenerationPlan(
        ...
        invalidation_scope=(
            "state_only_layer_08_event_risk_governor_and_event_adjusted_outputs; base-stack outputs remain reusable "
        ...
        regeneration_steps=(
            RegenerationStep(
                ...
                command_ref="python3 scripts/models/model_08_event_risk_governor/build_event_model_acceptance_report.py",
            ...
            RegenerationStep(
                ...
                action="generate feature_09_event_risk_governor then model_08_event_risk_governor/event_context_vector outputs",
                command_ref="trading-data-feature-09-event-risk-governor; python3 scripts/models/model_08_event_risk_governor/generate_model_08_event_risk_governor.py",
            ...
            RegenerationStep(
                ...
                command_ref="python3 scripts/models/model_08_event_risk_governor/evaluate_model_08_event_risk_governor.py; PYTHONPATH=src python3 scripts/tasks/plan_model_promotion_review.py --model event_risk_governor",
