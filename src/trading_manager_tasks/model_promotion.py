...
judgment and promotion readiness belong to trading-evaluation; runtime model
lifecycle and active-pointer writes belong to trading-execution.
"""
...
DEFAULT_POLICY_REFS = (
    ...
    "evaluation_promotion_readiness_policy",
