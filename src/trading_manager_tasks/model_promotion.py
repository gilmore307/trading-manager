...
MODEL_PROMOTION_TARGETS: tuple[ModelPromotionTarget, ...] = (
    ...
    ModelPromotionTarget("layer_07_position_projection", "position_projection_model", "PositionProjectionModel", "position_projection_vector", "position_projection_model", "model_06_position_projection"),
    ModelPromotionTarget("layer_08_underlying_action", "underlying_action_model", "UnderlyingActionModel", "underlying_action_plan", "underlying_action_model", "model_07_underlying_action"),
    ModelPromotionTarget("layer_09_option_expression", "option_expression_model", "OptionExpressionModel", "option_expression_plan", "option_expression_model", "model_08_option_expression"),
    ModelPromotionTarget("layer_10_event_risk_governor", "event_risk_governor", "EventRiskGovernor", "event_context_vector", "event_risk_governor", "model_09_event_risk_governor"),
)
...
TARGETS_BY_PHYSICAL_MODEL_ID = {
    target.physical_model_id or f"model_{int(target.layer_id.split('_')[1]):02d}_{target.layer_id.split('_', 2)[2]}": target
