            ...
            validate_failure_register_row(
                {
                    ...
                    "note": "Generated by manager_provider_stage_reconcile from a latest failed component receipt; requires agent review before correction, retry, or accepted skip.",
                }
            )
        )
    return tuple(rows)
