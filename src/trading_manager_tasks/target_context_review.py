...
DEFAULT_MAPPING_CSV = Path("/root/projects/trading-storage/main/shared/target_layer2_context_mapping.csv")
...
def build_target_context_agent_review_request(
    *,
    ...
    request = {
        ...
        "mapping_ref": "trading-storage/main/shared/target_layer2_context_mapping.csv",
