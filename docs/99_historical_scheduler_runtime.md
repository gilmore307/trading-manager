...
| Event risk governor / Layer 9 overlay | Separate event-intelligence overlay that may later review base Layer 8 guidance; it is bypassed for base workflow progression and must remain auditable side by side with the base decision. |
