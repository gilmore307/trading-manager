...
- Shared statuses and registrable fields are maintained in `trading-main/registry/`; registry operating rules are in `docs/07_registry.md`.
...
- exact registered status vocabulary and field names in `trading-main/registry/`, governed by `docs/07_registry.md`;
