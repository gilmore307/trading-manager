...
- Removed registry kind vocabulary validators from the runtime helper package; tests now compare SQL kind constraints with `scripts/kinds/*.md`.
...
- Removed canceled-project registry entries and regenerated `scripts/current.csv`.
