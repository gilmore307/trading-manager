...
```bash
PYTHONPATH=src python3 scripts/tasks/collect_dataset_evidence.py --write --output-path /root/projects/trading-storage/storage/control_plane/runtime/dataset_expansion/evidence.json
