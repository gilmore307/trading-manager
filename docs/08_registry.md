...
- control-plane-facing data sources, implemented data feeds, feed capabilities, final data-kind shapes, reusable templates, and shared artifacts;
...
- `data_source` — control-plane-facing runnable source boundaries.
