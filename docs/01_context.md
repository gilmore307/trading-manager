...
| `trading-evaluation` | Frozen benchmarks, fold settlement, promotion eligibility | Judges completed folds independently; manager records status but does not own model-quality judgment. |
