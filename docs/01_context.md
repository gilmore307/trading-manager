...
- `trading-main/scripts/registry/` and `docs/08_registry.md` for trading-wide registered names, status vocabularies, and registrable fields;
...
- `scripts/registry/` maintains the SQL-backed registration system; `docs/08_registry.md` explains the registry operating model.
...
- `trading-main/scripts/registry/` and `docs/08_registry.md` for registered names, shared status vocabularies, and registrable fields;
...
- Trading-wide status vocabularies and registrable fields belong in `trading-main/scripts/registry/`; registry operating details belong in `docs/08_registry.md`.
